...
enum Palette {
    ...
    /// Between the two: for a caption that should be found without hunting.
    static let textMid       = Color(hex: 0xA6A6A6)
    /// Brighter still: a number that is secondary but still a number.
    static let textBright    = Color(hex: 0xC8C8C8)
